        ...
        <div className="fcontent resizable">
                ...
                <div id="quicklinks" className="cardlayout">
                        <ul className="list">
                                ...
                                <li><a id="flink" href="#l2">Experience</a></li><br/>
                                <li><a id="flink" href="#l1">Gallery</a></li><br/>
                                <li><a id="flink" href="/sitemap.xml">Site-map</a></li><br/>                            
                        </ul>
                </div>
                <div id="quicklinks" className="cardlayout">
                        <ul className="list">
                                <h3 className="logofont">USEFUL LINKS</h3><br/>
                                <li id="flink"><a  href="#l2">About-us</a></li>
                                <li id="flink"><a  href="#l1">Properties</a></li>
                                <li id="flink"><a  href="#l2">Contact</a></li>                            
                                <li id="flink"><a  href="#l2">Blogs</a></li>     
                                <li id="flink"><a  href="/sitemap.xml">Site-map</a></li>                       
                        </ul>
                </div>
                <div id="quicklinks" className="cardlayout">
                        <ul className="list">
                                <h3 className="logofont">FEATURED PROPERTIES</h3><br/>
                                <li><a id="flink" href="#l2">Experience</a></li><br/>
                                <li><a id="flink" href="#l1">Gallery</a></li><br/>
                                <li><a id="flink" href="/sitemap.xml">Site-map</a></li><br/>                            
                        </ul>
